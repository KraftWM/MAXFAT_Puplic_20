function [ZVOUT, dOOUT] = bisektion(ZVIN, dOIN,...                    
                                           ...
                                           lastschritt,...
                                           varargin)
% BisektionvVerfahren f�r inkrementelle Kerbn�herung. Zuerst Newton Raphson
% Verfahren bis �berschie�en in einer komponente festegestellt wird. Dann
% Bisektionsverfahren, ohne dass ein weitere Newton Schritt ausgef�hrt
% wird.
%
% INPUT:
...
function [deps,fp,fm,dep,dem] = bisek(fp,fm,dep,dem,f,deps) 
    ...
    % pr�fe ob f zielfunktion verbessert
