...
% Implentation der Neuber Methode f�r mehrachsige Kerbn�herung
%
...
%     EESED(:,ii) = EESED(:,ii-1) + dEESED;
    ...
    while fnorm2 > tol
        ...
        [ZVAR(:,ii),~,CEP] = matfun(3, 2, dEPS, ZVAR(:,ii-1), 1, para);
        ...
        % Energieinkrement
        G = EPS + dEPS - REF(:,4);
        P = ZVAR(1:ntens,ii-1) + dSIG - REF(:,3);
        dTSED = P .* dEPS + ...
                G .* dSIG - ...
                dEPS .* dSIG;
        dtsed = sum(dTSED);
