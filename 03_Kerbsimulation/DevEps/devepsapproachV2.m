function [ZVAR0, EZVAR0] = devepsapproachV2( ...
                                   ...
                                   Outfile)
% Funktion f�hrt deviatorischen Dehnungsapproach nach Hertl aus
%
% AKTUELL NUR F�R ESZ 
%
% INPUT:
...
% SIGO           -> Oberfl�chennormalspannung f�r hydrostatische Korrektur
%                   (0 im ESZ)
...
while aktdat <= numink
    ...
    DATA = fread(Infile,[4,space],'double');                         % Einlesen Durchlaufz�hler und pseudo Spannungen
    % Setzten Startwerte
    DATA = [DATA0,DATA];
    ESIG = DATA(2:4,:);
