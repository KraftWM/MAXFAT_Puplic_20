...
% KONSTRUKTOR:
%    P = PZ(E,nu,Rm,Kstrich,nstrich,sf,ef,bf,cf,ND,nst,varargin);
%           E            - E Modul
%           nu           - Querdehnzahl
%           Rm           - Zugfestigkeit
%           Kstrich      - Parameter Ramberg Osgood
%           nstrich      - Parameter Ramberg Osgood
%         sf,bf,ef,cf    - Dehnungswöhlerlinie
%         nst            - Stüzziffer
...
%   Kstrich      - Parameter Ramberg Osgood
%   nstrich      - Parameter Ramberg Osgood
% sf,bf,ef,cf,ND - Dehnungswöhlerlinie
% nst            - Stüzziffer
...
% PUBLIC:
   properties % Notwendige Größen für Kerbnäherung
       ...
       Rm {mustBeNumeric} = NaN;                                           % Zugfestigkeit
       Kstrich {mustBeNumeric} = NaN;                                      % Parameter Ramberg Osgood
       nstrich {mustBeNumeric} = NaN;                                      % Parameter Ramberg Osgood
       sf {mustBeNumeric} = NaN;                                           % 
       ef {mustBeNumeric} = NaN;                                           % 
       bf {mustBeNumeric} = NaN;                                           % 
       cf {mustBeNumeric} = NaN;                                           % Dehnungswöhlerlinie
       ND {mustBeNumeric} = NaN;                                           % Dauerfestigkeit
       nst {mustBeNumeric} = 1;                                            % Stüzziffer
...
% ------------------------------------------------------------------------- 
methods
    function obj = PZ2(E,nu,Rm,Kstrich,nstrich,sf,ef,bf,cf,ND,varargin)
        %------------------------------------------------------------------
