...
%    Modellgleichung ESZ Karim Ohno Modell                                %
%                                                                         %
%    Aufgerufen in:                                                       %
%    karimohno.m                                                          %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function X_neu = CoderVersion_ESZ_KarimOhno(eps_n, epsp_n, alpha_n,p_n,...
                           sig_tr,ink,ink_flag,...
                           parameter,...
                           D,P,P_line,P_hat,A)
% Konkretes Materialmodell f�r ESZ Spannungszust�nde, gibt bei vorgabe 
...
% erster schritt
if ink_flag == 0
    dpiter(iter) = verfahren_sig(s_tr,alpha_n,Y_np1,G,h_i,theta_i,P_line);
else
    dpiter(iter) = verfahren_eps(s_tr,alpha_n,Y_np1,G,h_i,theta_i,P_line);
end
...
while normp > tol
    ...
    % Inkrementieren Schleifenz�hler
    iter = iter + 1;
