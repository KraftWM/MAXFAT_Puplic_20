...
%    Modellgleichung ESZ Jiang Modell f�r Integration nach Lang           %
%                                                                         %
%    Aufgerufen in:                                                       %
%    jianglang.m                                                          %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Inkrements des System von DGL f�rs Jiang Modell mit den Ansatz von Lang
%
% INPUT:
...
% Radius Pseudo Flie�fl�che
ek = ek1 .* ( 1 + eak * exp( eck * erm ) );

%--------------------------------------------------------------------------
%               Normale an die Strucktur Flie�fl�che
%--------------------------------------------------------------------------
...
% Schleife �ber alle Backstresstensoren
% !!!! BERECHNUNGEN W�RDE AUCH OHNE SCHLEIFE GEHEN ABER OHNO WANG HAT
...
%--------------------------------------------------------------------------
%                  Ableitungen der Ged�chtniss- und Flie�fl�chen                     
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
%                  inkrement plastische Bogenl�nge                   
%--------------------------------------------------------------------------
